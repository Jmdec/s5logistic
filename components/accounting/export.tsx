...
const Export: React.FC<HeroUIProps> = ({ label }) => {
    ...
    const exportToPDF = () => {
        ...
        if (content) {
            ...
            doc.text("S5 Logistics Inc.", centerX, 40, { align: "center" });
            doc.text("New Cavite Industrial City, Maria St State Land, Manggahan,", centerX, 45, { align: "center" });
            doc.text("General Trias, Cavite", centerX, 50, { align: "center" });
            doc.text("s5logisticsInc.Cavite@gmail.com", centerX, 55, { align: "center" });
    ...
    const printPage = () => {
        ...
        if (printWindow) {
            printWindow.document.write(`
                ...
                <body>
                    <div class="header">
                        <img src="/S5Logo.png" class="logo" alt="S5 Logistics Inc." />
                        <p class="details">
                            New Cavite Industrial City, Maria St State Land, Manggahan, General Trias, Cavite <br>
