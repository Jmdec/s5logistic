...
const Calendar: React.FC = () => {
    ...
    return (
      ...
      >
        <div className="modal-content">
          ...
          <p><strong>Initial Amount:</strong> ${selectedEvent.initial_amount}</p>
          <p><strong>Payment Per Month:</strong> ${selectedEvent.payment_per_month}</p>
          <p><strong>Total Payment:</strong> ${selectedEvent.total_payment}</p>
        </div>
  ...
  return (
    <div className="calendar-container w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <FullCalendar
